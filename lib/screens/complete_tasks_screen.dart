...
class _CompleteTasksScreenState extends State<CompleteTasksScreen> {
  ...
  void didChangeDependencies() {
    ...
    loadAllCompleteTasks();
  }

  void loadAllCompleteTasks() async {
    completeTaskList.clear();
    completeTaskList.addAll(await taskDao!.getCompletedTask());
    setState(() {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('${completeTaskList.length} Completed Tasks',
                      style: TextStyle(
                        fontFamily: 'roboto',
                        color: Colors.white,
                        fontSize: 15,
  ...
  Widget _item(int index) {
    return searchText.isEmpty ? Padding(
      ...
      child: SwipeActionCell(
        key: ObjectKey(completeTaskList[index]),
                      ...
                      return CupertinoAlertDialog(
                        ...
                        actions: <Widget>[
                          CupertinoDialogAction(
                            ...
                            onPressed: () async {
                              await taskDao!.deleteTask(completeTaskList[index]);
                              Navigator.pop(context);
                              await handler(true);
                              completeTaskList.removeAt(index);
                              loadAllCompleteTasks();
                            },
                          ),
                          CupertinoDialogAction(
        ...
        child: Padding(
          ...
          child: Container(
            child: Row(
              ...
              children: [
                Text(
                  completeTaskList[index].taskName,
                  style: TextStyle(
                      color: Colors.black,
                      fontSize: 15,
                      fontWeight: FontWeight.bold),
    ...
    ) : completeTaskList[index].taskName.toLowerCase().contains(searchText.toLowerCase()) ? Padding(
      padding: const EdgeInsets.all(8.0),
      child: SwipeActionCell(
        key: ObjectKey(completeTaskList[index]),
        trailingActions: <SwipeAction>[
